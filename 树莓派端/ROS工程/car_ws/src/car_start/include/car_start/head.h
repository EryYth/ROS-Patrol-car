...
#define WHEEL_BASE			0.196f

#define RECIVER_DATA_HEADER 		0X01234567
#define RECIVER_DATA_CHECK_SUM 		0X89
#define PROTOBUF_SIZE				29
...
class Start_object
{
	...
	private:
		...
		ros::Publisher odom_pub, imu_pub, imu_pub_raw;
